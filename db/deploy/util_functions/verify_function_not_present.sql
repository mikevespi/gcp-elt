-- Deploy dem:util_functions/verify_function_not_present to pg
...
comment on function dem_private.verify_function_not_present(text, text, int) is 'Utility function to use in a change verification or test to ensure that a function was deleted';
