...
create table test_table_all (
  ...
  created_by int references dem.dem_user,
  updated_at timestamp with time zone not null default now(),
  updated_by int references dem.dem_user,
  archived_at timestamp with time zone,
  archived_by int references dem.dem_user
);
...
select is (
  ...
  (select id from dem.dem_user where uuid='11111111-1111-1111-1111-111111111112'),
